...
import 'package:contratado/src/dicontainer/api/api_dicontainer.dart';
import 'package:contratado/src/dicontainer/dicontainer.dart';
import 'package:contratado/src/ui/widgets/publication_card.dart';
...
class _ServiceProvidersPublicationsPageState
  ...
  late DIContainer apidiContainer;
  late IPublicationService publicationService;
  ...
  initState() {
    super.initState();
    apidiContainer = APIDIContainer();
    publicationService = apidiContainer.getPublicationService();
  }
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  Map<String, dynamic> json = {
                    ...
                    'user_description': _userDescriptionController.text
                  };
                  publicationService.create(Publication.fromJson(json));
